										...
										<div class="row">
	                        		 		...
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="sale_price" type="number" autocomplete="off" id="sale_price" name="sale_price" class="form-control" placeholder="Sale price"></sf:input>
                                        		</div>
	                                    	</div>
										</div>
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:textarea path="short_description" id="short_description" name="short_description"
										...
										<div class="row">
	                        		 		<div class="col-md-12">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:textarea path="detail_description" id="detail_description" name="detail_description"
										...
										<div class="row">
	                        		 		<div class="col-md-2">
												<div class="form-group mb-4">
													...
													<sf:checkbox path="is_hot" class="form-check-input" id="is_hot" name="is_hot"></sf:checkbox>
			                                        <label for="is_hot">Is a hot product?</label>
