										...
										<div class="row">
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:select path="roleCreaterole.id" class="form-control" id="roleCreaterole">
											...
											<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:select path="roleUpdaterole.id" class="form-control" id="roleUpdaterole">
			                                            <sf:options items="${roles }" itemValue="id" itemLabel="name"></sf:options>
			                                        </sf:select>
                                        		</div>
	                                    	</div>
										...
										<div class="row">
	                        		 		<div class="col-md-6">
												<div class="form-group mb-4">
			                                        ...
			                                        <sf:input path="status" type="text" class="form-control" id="status" name="status" placeholder="status"></sf:input>
                                        		</div>
	                                    	</div>	                                    	
										</div>
