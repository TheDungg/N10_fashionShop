	                        	...
	                        	<form action="${classpath }/admin/product-list" method="get">
		                            <div class="table-responsive">
	                               	...
	                               	<div class="row">
										...
										<div class="col-md-4">
											<div class="form-group mb-4">
												<h3>Total products: &nbsp ${total }</h3>
	                                    ...
	                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
	                                        ...
	                                        <tbody>
	                                            ...
	                                            <tr>
	                                                ...
	                                                <td align="right">
	                                                <fmt:formatNumber value="${product.sale_price }" minFractionDigits="0"></fmt:formatNumber>
	                                                ...
	                                                <td>
	                                                	<span id="_product_is_hot_${product.id }">
	                                                		<c:choose>
	                                    ...
	                                    <div class="row">
		                        		 		<div class="col-md-6">
													<div class="form-group mb-4">
		                                        		<a href="${classpath }admin/product-add" role="button" class="btn btn-primary">Add new product</a>
	                                      			</div>
		                                    	</div>
